...
export const scenes: Scene[] = [
  { id: "open", number: "01", nav: "启幕", eyebrow: "中海物业增值服务", title: "从社区到城区，让空间持续创造价值", body: "40余年央企物业经验，首家在港上市。覆盖160+城市、2300+项目，服务1000万+业主，管理4.3亿㎡物业空间。", tags: ["全业态", "全周期", "全场景"], still: `${assetBase}stills/scene-01.png`, start: 0, accent: "#D4A574", stats: [ { value: "160+", label: "覆盖城市" }, { value: "2300+", label: "服务项目" }, { value: "1000万+", label: "服务业主" }, { value: "4.3亿㎡", label: "管理面积" } ] },
